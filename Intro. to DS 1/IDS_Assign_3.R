...
total = Numvec1 + Numvec2 # vector addition, + operator adds
...
#calculate mean of the data vector
...
myDataframe[1,2] #fisrt row second column 
...
Tipping = read_tsv(file = "C:\\Users\\juver\\Downloads\\Tipping Data.txt" )
...
# Enter your code below:
arrange(Tipping, -total_bill, -tip)
...
# Enter your code below:
Tipping %>% group_by(sex) %>% summarise(Tipping, AvgTip = mean(tip))
...
# Enter your code below:
ggplot(Tipping, aes(tip,)) + geom_histogram( colour = "white", fill="blue") + ggtitle("Tipping Details of Customers") + labs(x = "Tip Amount", y = "Number of Poeple")